...
<title>AI based Banking | Add Area</title>
<!-- plugins:css -->
<link rel="stylesheet"
							...
							<div class="card">
								<div class="card-body">
									...
									<f:form class="cmxform" id="commentForm" method="post"
										onsubmit="return addArea()" action="saveArea" modelAttribute="AreaVO">
										<fieldset>
											<div class="form-group">
												<label for="cname">Area Name</label>
												<f:input id="areaName" class="form-control" name="areaName"
													type="text" path="areaName" onkeypress='return event.charCode>=65 && event.charCode<=90 || event.charCode>=97 && event.charCode<=122 || event.charCode==32' />
											</div>

											<div class="form-group">
												<label for="ccomment">Area Description</label>
												<f:textarea id="areaDescription" class="form-control"
													path="areaDescription" name="areaDescription"></f:textarea>
											</div>
