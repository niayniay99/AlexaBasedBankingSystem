...
<title>AI based Banking | View Area</title>
<!-- plugins:css -->
<link rel="stylesheet"
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						...
						<a href="addArea" style="float:right;" class="col-1">
							<input class="btn btn-primary" type="button" value="Add">
						</a><h4 class="">View Area</h4>
					</div>
											...
											<tbody>
												...
												<c:forEach items="${areaList}" var="i" varStatus="j">
													<tr>
														...
														<td><a href="editArea?id=${i.areaid}"> <i class="mdi mdi-pencil-box"
																style="font-size: 20px;"></i>
														</a><a href="deleteArea?id=${i.areaid}"> <i class="mdi mdi-delete"
